    ...
    public class SampleSplitButton : IBarDropButton
    {
        ...
        public void OnDropDownOpening(ToolStripDropDownMenu menu) {
            ...
            if(fFirstMenuDropDown) {
                menu.Items.Add(new ToolStripMenuItem("´ò¿ªÎÄ¼þ¼Ð"));
                menu.Items.Add(new ToolStripMenuItem("²âÊÔÑ¡ÖÐ"));
                menu.Items.Add(new ToolStripMenuItem("²âÊÔ±êÇ©Ëø¶¨×´Ì¬"));
